                ...
                <tbody class="bg-white">
                    @foreach ($pruebas as $prueba)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                {{ $prueba->averageSpanishPQ }}
                            </td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                {{ $prueba->correctSpanishPQ }}
                            </td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                {{ $prueba->incorrectSpanishPQ }}
                            </td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                {{ $prueba->regularSpanishPQ }}
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                @if ($prueba->spanishPQ6 > 0)
                                    {{ $prueba->spanishPQ6 }}
                                @else
                            ...
                            <td >
                                <button
                                    onclick="window.location.href='{{ route('history.answers.spanish5', $prueba->id) }}'"
