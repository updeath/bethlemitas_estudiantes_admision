...
@section('content')
    ...
    <div class="flex items-center">
        <div class=" lg:w-1/2 xl:max-w-screen-sm">
            <div class=" flex justify-center lg:justify-start lg:px-12">
            ...
            <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                <h2
                    class="text-center text-3xl text-gray-900 font-display font-medium lg:text-left xl:text-5xl
                    xl:text-bold">
                    ...
                    <form action="{{ route('verifyEmail') }}" method="POST">
                        ...
                        @if (session('message'))
                            <div class="flex items-center p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50"
                                ...
                                <div>
                                    <span class="font-medium">Exito</span> {{ session('message') }}
                                </div>
                            </div>
