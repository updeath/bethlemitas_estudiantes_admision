...
<div class="lg:flex">
    <div class="lg:w-1/2 xl:max-w-screen-sm">
        <div class="py-4 lg:bg-white flex justify-center lg:justify-start lg:px-12">
            <div class="cursor-pointer flex items-center">
                <div>
                <img class="w-[70px] h-[70px]" src="{{ asset('img/logo.png') }}">
                </div>
                <div class="text-3xl text-gray-800 tracking-wide ml-2 font-bold"><em>Bethlemitas Pereira</em></div>
            </div>
        </div>
        <div class=" px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-10 xl:px-24 xl:max-w-2xl">
            <h2 class="text-center text-4xl text-gray-900 font-display font-semibold lg:text-left xl:text-5xl
            ...
            <div class="mt-12">
                <form action="{{ route('updatePassword') }}" method="POST">
                    ...
                    <div>
                        ...
                        <input id="email" name="email" value="{{ session('email') }} {{ old('email') }} " 
                        ...
                        @if ($errors->has('email'))
                        <p class="mt-1 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Correo
                                incorrecto</span></p>
                        @endif
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <p class="mt-1 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Contraseña
                                incorrecta</span> </p>
                        @endif
                    </div>

                    <div class="mt-4">
                        <div class="text-sm font-bold text-gray-700 tracking-wide">Confirmar Contraseña</div>
                    ...
                    <div>
                                <a href="{{ route('login') }}" class="text-xs font-display font-semibold text-yellow-600 hover:text-yellow-800
                                        cursor-pointer">
                    ...
                    <div class="mt-10">
                        <button class="bg-yellow-500 text-gray-100 p-4 w-full rounded-full tracking-wide
    ...
    <div class="hidden lg:flex items-center justify-center bg-gray-300 flex-1 h-screen">
        <div class="max-w-xs transform">
            <svg class="w-5/6 mx-auto" xmlns="http://www.w3.org/2000/svg" id="f080dbb7-9b2b-439b-a118-60b91c514f72"
                ...
                <polygon points="323 691.063 0 674.063 0 17.063 323 0.063 323 691.063" fill="#BA9708" />
                ...
                <polygon
                    ...
                    fill="#535461" />
                <polygon points="337 691.063 317.217 691 318 0.063 337 0.063 337 691.063" fill="#BA9708" />
                <g opacity="0.1">
                    <polygon points="337.217 691 317.217 691 318.217 0 337.217 0 337.217 691" fill="#7f9cf5" />
                </g>
                ...
                <path d="M735.8586,266.93948s-13,0-16,18-6,78-6,78-42,55-35,62,15,20,20,18,48-61,48-61Z"
                    transform="translate(-335.6414 -100.11607)" fill="#FFFFFF" />
                <path d="M735.8586,266.93948s-13,0-16,18-6,78-6,78-42,55-35,62,15,20,20,18,48-61,48-61Z"
                ...
                <path
                    ...
                    transform="translate(-335.6414 -100.11607)" fill="#203749" />
                ...
                <path
                    ...
                    transform="translate(-335.6414 -100.11607)" fill="#E0E0DB" />
