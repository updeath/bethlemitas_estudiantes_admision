...
@section('sub_title', 'Resultados de Grados 8 - Lengua Castellana - Observaciones')

@section('content_dashboard')

    <div class="flex flex-col lg:flex-row items-center justify-between m-2">
        <div class="relative">
            <form action="{{ route('tables2.spanish8') }}" method="GET" class="flex items-center">
    ...
    <div class="flex flex-col mt-8">
        <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
            <div class="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
                    ...
                    <tbody class="bg-white">
                        @foreach ($promedioData as $data)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <a href="{{ route('generate.pdf.spanish8', ['userId' => $data['user']->id]) }}"
                ...
                <div
                    class="bg-white px-4 py-3 border-t text-gray-900 dark:text-white">
                    {{ $users->links() }}
                </div>
            </div>
        </div>
                ...
                <div class="bg-gray-50 px-4 py-5 sm:p-6">
                    ...
                    @if (isset($data['user']))
                        <form id="observationForm"
                            action="{{ route('save.observationsSpanishPO', ['userId' => $data['user']->id]) }}" method="POST">
                            @csrf
                            <div class="mb-4">
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <div class="bg-gray-50 px-4 py-5 sm:p-6">
                    ...
                    @if (isset($data['user']))
                        <form id="observationForm"
                            action="{{ route('save.observationsSpanishPO2', ['userId' => $data['user']->id]) }}" method="POST">
                            @csrf
                            <div class="mb-4">
                                <label for="observationTextarea"
                                    class="block text-sm font-medium text-gray-700">Observación:</label>
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <div class="bg-gray-50 px-4 py-5 sm:p-6">
                    ...
                    @if (isset($data['user']))
                        <form id="observationForm"
                            action="{{ route('save.observationsSpanishPO3', ['userId' => $data['user']->id]) }}" method="POST">
                            @csrf
                            <div class="mb-4">
                                <label for="observationTextarea"
                                    class="block text-sm font-medium text-gray-700">Observación:</label>
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <div class="bg-gray-50 px-4 py-5 sm:p-6">
                    ...
                    @if (isset($data['user']))
                        <form id="observationForm"
                            action="{{ route('save.observationsSpanishPO4', ['userId' => $data['user']->id]) }}" method="POST">
                            @csrf
                            <div class="mb-4">
                                <label for="observationTextarea"
                                    class="block text-sm font-medium text-gray-700">Observación:</label>
    ...
    <a href="{{route('tables.spanish6')}}" type="submit"
