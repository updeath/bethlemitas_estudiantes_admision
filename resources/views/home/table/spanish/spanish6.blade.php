...
@section('sub_title', 'Resultados de Grados 6 - Lengua Castellana')
...
<style>
    ...
    <div class="flex flex-col lg:flex-row items-center justify-between m-2">
        <div class="flex items-center mb-2 lg:mb-0">
            <form id="resetearForm" action="{{ route('reset.spanish6') }}" method="POST">
                @csrf
            ...
            <div class="m-2">
                <a href="{{ route('exportar.excel.Spanish6') }}"
        ...
        <div class="relative">
            <form action="{{ route('tables.spanish6') }}" method="GET" class="flex items-center">
                    ...
                    <tbody class="bg-white">
                        @foreach ($promedioData as $data)
                            <tr>
                                ...
                                <td >
                                    <button
                                        onclick="window.location.href='{{ route('answer.SpanishSexto', ['userId' => $data['user']->id]) }}'"
                                        class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-1 px-2 rounded transition duration-300 ml-2">
                                        <i class="fas fa-file text-sm"></i>
                                    </button>
                                </td>
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <a href=" {{ route('historySpanish6.user', $data['user']->id) }}" class="text-blue-500 hover:underline">
                                        Ver historial
                                    </a>
                                </td>
                            </tr>
        ...
        <div class="modal-dialog w-full md:w-1/2 lg:w-1/3 xl:w-1/3">
            <div class="modal-content border border-blue-500 bg-white rounded-lg shadow-lg">
                <div class="modal-header bg-blue-500 text-white border-b border-gray-300 py-4 px-6 rounded-t-lg">
                    <h5 class="modal-title text-xl font-semibold" id="bookModalTitle"><em>Pregunta 1 - Grado 6</em></h5>
                    <p class="text-white text-sm">1. ¿Qué es el género narrativo? Argumente su respuesta.</p>
                </div>
    ...
    <div class="fixed inset-0 z-50 overflow-auto bg-black bg-opacity-50 flex items-center justify-center" id="bookModal2"
        ...
        <div class="modal-dialog w-full md:w-1/2 lg:w-1/3 xl:w-1/3">
            <div class="modal-content border border-blue-500 bg-white rounded-lg shadow-lg">
                <div class="modal-header bg-blue-500 text-white border-b border-gray-300 py-4 px-6 rounded-t-lg">
                    <h5 class="modal-title text-xl font-semibold" id="bookModalTitle2"><em>Pregunta 2 - Grado 6</em></h5>
                    <p class="text-white text-sm">2. ¿Cuáles son los subgéneros narrativos? Enumérelos y escriba las
                        características de cada uno.</p>
                </div>
    ...
    <div class="fixed inset-0 z-50 overflow-auto bg-black bg-opacity-50 flex items-center justify-center" id="bookModal3"
        ...
        <div class="modal-dialog w-full md:w-1/2 lg:w-1/3 xl:w-1/3">
            <div class="modal-content border border-blue-500 bg-white rounded-lg shadow-lg">
                <div class="modal-header bg-blue-500 text-white border-b border-gray-300 py-4 px-6 rounded-t-lg">
                    <h5 class="modal-title text-xl font-semibold" id="bookModalTitle3"><em>Pregunta 3 - Grado 6</em></h5>
                    <p class="text-white text-sm">3. ¿Qué es el género lírico? Argumente su respuesta.</p>
                </div>
    ...
    <div class="fixed inset-0 z-50 overflow-auto bg-black bg-opacity-50 flex items-center justify-center" id="bookModal4"
        ...
        <div class="modal-dialog w-full md:w-1/2 lg:w-1/3 xl:w-1/3">
            <div class="modal-content border border-blue-500 bg-white rounded-lg shadow-lg">
                <div class="modal-header bg-blue-500 text-white border-b border-gray-300 py-4 px-6 rounded-t-lg">
                    <h5 class="modal-title text-xl font-semibold" id="bookModalTitle4"><em>Pregunta 4 - Grado 6</em></h5>
                    <p class="text-white text-sm">4. ¿Qué tipo de textos hacen parte del género lírico? Menciónelos y
                        escriba cuáles son sus características.</p>
                </div>
    ...
    <div class="fixed inset-0 z-50 overflow-auto bg-black bg-opacity-50 flex items-center justify-center" id="bookModal5"
        ...
        <div class="modal-dialog w-full md:w-1/2 lg:w-1/3 xl:w-1/3">
            <div class="modal-content border border-blue-500 bg-white rounded-lg shadow-lg">
                <div class="modal-header bg-blue-500 text-white border-b border-gray-300 py-4 px-6 rounded-t-lg">
                    <h5 class="modal-title text-xl font-semibold" id="bookModalTitle5"><em>Pregunta 5 - Grado 6</em></h5>
                    <p class="text-white text-sm">5. ¿Qué es el género dramático? Argumente su respuesta y mencione algunos
                        ejemplos de los textos dramáticos.</p>
                </div>
    ...
    <div class="fixed inset-0 z-50 overflow-auto bg-black bg-opacity-50 flex items-center justify-center" id="bookModal6"
        ...
        <div class="modal-dialog w-full md:w-1/2 lg:w-1/3 xl:w-1/3">
            <div class="modal-content border border-blue-500 bg-white rounded-lg shadow-lg">
                <div class="modal-header bg-blue-500 text-white border-b border-gray-300 py-4 px-6 rounded-t-lg">
                    <h5 class="modal-title text-xl font-semibold" id="bookModalTitle6"><em>Pregunta 6 - Grado 6</em></h5>
                    <p class="text-white text-sm">6. Escriba las características propias y las diferencias, entre el mito y
                        la leyenda:</p>
                </div>
