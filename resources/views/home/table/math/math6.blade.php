...
@section('sub_title', 'Resultados de Grados 6 - Matemáticas')
...
<style>
    ...
    <div class="flex flex-col lg:flex-row items-center justify-between m-2">
        <div class="flex items-center mb-2 lg:mb-0">
            <form id="resetearForm" action="{{route('reset.math6')}}" method="POST">
                @csrf
            ...
            <div class="m-2">
                <a href="{{route('exportar.excel.math6')}}" class="bg-green-700 hover:bg-green-800 text-white font-bold py-2 px-4 rounded-lg">
        ...
        <div class="relative">
            <form action="{{route('table.math6')}}" method="GET" class="flex items-center">
                    ...
                    <tbody class="bg-white">
                        @foreach ($promedioData as $data)
                            <tr>
                                ...
                                <td >
                                    <button
                                        onclick="window.location.href='{{ route('answer.mathSexto', ['userId' => $data['user']->id]) }}'"
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <a href="{{ route('history6.user', $data['user']->id ) }}" class="text-blue-500 hover:underline">
                                        Ver historial
                                    </a>
                                </td>
