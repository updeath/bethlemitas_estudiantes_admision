...
@section('sub_title', 'Resultados de Grados 9 - Lengua Castellana')

@section('content_dashboard')

    <div class="flex flex-col lg:flex-row items-center justify-between m-2">
        <div class="flex items-center mb-2 lg:mb-0">
            <form id="resetearForm" action="{{ route('reset.spanish9') }}" method="POST">
                @csrf
            ...
            <div class="m-2">
                <a href="{{route('exportar.excel.Spanish9')}}" class="bg-green-700 hover:bg-green-800 text-white font-bold py-2 px-4 rounded-lg">
        ...
        <div class="relative">
            <form action="{{ route('tables.spanish9') }}" method="GET" class="flex items-center">
                ...
                <table class="min-w-full">
                    <thead>
                        <tr>
                            ...
                            <th
                                class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">
                                Observaciones del Coordinador</th>

                            <th
                                class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">
                                Observaciones del Psicooriantador</th>
                            ...
                            <th
                                class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">
                                Observaciones del Secretario(a)</th>
                            <th
                                class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">
                                PDF</th>
                    ...
                    <tbody class="bg-white">
                        @foreach ($promedioData as $data)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <a href="{{ route('generate.pdf.spanish9', ['userId' => $data['user']->id]) }}"
                ...
                <div class="bg-gray-50 px-4 py-5 sm:p-6">
                    ...
                    @if (isset($data['user']))
                        <form id="observationForm"
                            action="{{ route('save.observationsSpanishPNO', ['userId' => $data['user']->id]) }}"
                            method="POST">
                            @csrf
                            <div class="mb-4">
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <div class="bg-gray-50 px-4 py-5 sm:p-6">
                    ...
                    @if (isset($data['user']))
                        <form id="observationForm"
                            action="{{ route('save.observationsSpanishPNO2', ['userId' => $data['user']->id]) }}"
                            method="POST">
                            @csrf
                            <div class="mb-4">
                                <label for="observationTextarea"
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <div class="bg-gray-50 px-4 py-5 sm:p-6">
                    ...
                    @if (isset($data['user']))
                        <form id="observationForm"
                            action="{{ route('save.observationsSpanishPNO3', ['userId' => $data['user']->id]) }}"
                            method="POST">
                            @csrf
                            <div class="mb-4">
                                <label for="observationTextarea"
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <div class="bg-gray-50 px-4 py-5 sm:p-6">
                    ...
                    @if (isset($data['user']))
                        <form id="observationForm"
                            action="{{ route('save.observationsSpanishPNO4', ['userId' => $data['user']->id]) }}"
                            method="POST">
                            @csrf
                            <div class="mb-4">
                                <label for="observationTextarea"
