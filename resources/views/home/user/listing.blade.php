...
@section('sub_title', 'Listado de usuarios')
...
<div class="flex flex-col lg:flex-row items-center justify-between m-2">
    <div class="flex items-center mb-2 lg:mb-0">
        <div class="m-2">
            <a href="{{route('exportar.usuarios')}}"
    ...
    <div class="relative">
        <form action="{{ route('listingUser') }}" method="GET" class="flex items-center">
            ...
            <table class="max-w-full">
                ...
                <tbody class="bg-white">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 w-10 h-10">
                                    @if ($user->image)
                                    <img name='image' id="image" src="{{ asset($user->image) }}" alt="Foto del perfil"
                        ...
                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                            <div class="text-sm leading-5 text-gray-900">{{ $user->iphone }}</div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                            <div class="text-sm leading-5 text-gray-900">{{ $user->degree ?? 0 }}</div>
                        </td>
                        ...
                        <td
                            ...
                            {{ $userRoles[$user->id] }}
                            @endif
                            @if($user->asignature == 'math')
                            <b class="font-medium text-gray-700"> <br>Matemáticas</b>
                            @elseif($user->asignature == 'english')
