...
@section('sub_title', 'Resultados de Grados 6 - Lengua Castellana - Observaciones')

@section('content_dashboard')

    <div class="flex flex-col lg:flex-row items-center justify-between m-2">
        <div class="relative">
            <form action="{{ route('tables2.spanish6') }}" method="GET" class="flex items-center">
                    ...
                    <tbody class="bg-white">
                        @foreach ($promedioData as $data)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <a href="{{ route('generate.pdf.spanish6', ['userId' => $data['user']->id]) }}"
                ...
                <div class="bg-gray-50 px-4 py-5 sm:p-6">
                    ...
                    @if (isset($data['user']))
                        <form id="observationForm"
                            action="{{ route('save.observationsSpanishPSX', ['userId' => $data['user']->id]) }}" method="POST">
                            @csrf
                            <div class="mb-4">
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <div class="bg-gray-50 px-4 py-5 sm:p-6">
                    ...
                    @if (isset($data['user']))
                        <form id="observationForm"
                            action="{{ route('save.observationsSpanishPSX2', ['userId' => $data['user']->id]) }}" method="POST">
                            @csrf
                            <div class="mb-4">
                                <label for="observationTextarea"
                                    class="block text-sm font-medium text-gray-700">Observación:</label>
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <div class="bg-gray-50 px-4 py-5 sm:p-6">
                    ...
                    @if (isset($data['user']))
                        <form id="observationForm"
                            action="{{ route('save.observationsSpanishPSX3', ['userId' => $data['user']->id]) }}" method="POST">
                            @csrf
                            <div class="mb-4">
                                <label for="observationTextarea"
                                    class="block text-sm font-medium text-gray-700">Observación:</label>
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <div class="bg-gray-50 px-4 py-5 sm:p-6">
                    ...
                    @if (isset($data['user']))
                        <form id="observationForm"
                            action="{{ route('save.observationsSpanishPSX4', ['userId' => $data['user']->id]) }}" method="POST">
                            @csrf
                            <div class="mb-4">
                                <label for="observationTextarea"
                                    class="block text-sm font-medium text-gray-700">Observación:</label>
