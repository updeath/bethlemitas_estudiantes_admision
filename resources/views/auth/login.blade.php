...
<div class="lg:flex">
    <div class="lg:w-1/2 xl:max-w-screen-sm">
        <div class="py-10 bg-yellow-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
            <div class="cursor-pointer flex items-center">
                <div>
                <img class="w-[80px] h-[80px]" src="{{ asset('img/logo.png') }}">
                </div>
                <div class="text-3xl text-gray-800 tracking-wide ml-2 font-bold"><em>Bethlemitas Pereira</em></div>
            </div>
        </div>
        <div class="mt-7 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
            ...
            <div class="mt-12">
                <form action="{{route('authenticate')}}" method="POST">
                    ...
                    <div>
                        ...
                        @if ($errors->has('number_documment'))
                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Número 
                            de doumento incorrecto</span></p>
                        @endif
                    </div>
                    <div class="mt-8">
                        <div class="flex justify-between items-center">
                            ...
                            <div>
                                <a href="{{ route('forgotpassword') }}" class="text-xs font-display font-semibold text-yellow-600 hover:text-yellow-800
                                        cursor-pointer">
                        ...
                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Contraseña
                                incorrecta</span> </p>
                        @endif
                    </div>
