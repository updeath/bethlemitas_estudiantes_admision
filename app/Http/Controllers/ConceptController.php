    ...
    public function index_concept(Request $request)
    {
        ...
        if ($auth_user->hasRole(['Admin', 'Docente','Psicoorientador','CoordinadorAcademico', 'CoordinadorConvivencia', 'Rector','Secretaria'])) {
            ...
            foreach ($users as $user) {
                ...
                if ($user->degree == '4°') {
                    $promedios['admin_data'][$user->id]['mathCuarto'] = MathCuarto::where('user_id', $user->id)->where('state', 'activo')->pluck('average')->first();

                    $promedios['admin_data'][$user->id]['spanishCuarto'] = SpanishCuarto::where('user_id', $user->id)->where('state', 'activo')->pluck('averageSpanishPC')->first();
                    ...
                    $promedios['admin_data'][$user->id]['mathQuinto'] = MathQuinto::where('user_id', $user->id)->where('state', 'activo')->pluck('averagePQ')->first();

                    $promedios['admin_data'][$user->id]['spanishQuinto'] = SpanishQuinto::where('user_id', $user->id)->where('state', 'activo')->pluck('averageSpanishPQ')->first();
                    ...
                    $promedios['admin_data'][$user->id]['mathSexto'] = MathSexto::where('user_id', $user->id)
                    ->where('state', 'activo')->pluck('averagePSX')->first();
                    $promedios['admin_data'][$user->id]['spanishSexto'] = SpanishSexto::where('user_id', $user->id)->where('state', 'activo')->pluck('averageSpanishPSX')->first();
                    ...
                    $promedios['admin_data'][$user->id]['mathSeptimo'] = MathSeptimo::where('user_id', $user->id)->where('state', 'activo')->pluck('averagePS')->first();
                    $promedios['admin_data'][$user->id]['spanishSeptimo'] = SpanishSeptimo::where('user_id', $user->id)->where('state', 'activo')->pluck('averageSpanishPS')->first();
                    ...
                    $promedios['admin_data'][$user->id]['mathOctavo'] = MathOctavo::where('user_id', $user->id)->where('state', 'activo')->pluck('averagePO')->first();
                    $promedios['admin_data'][$user->id]['spanishOctavo'] = SpanishOctavo::where('user_id', $user->id)->where('state', 'activo')->pluck('averageSpanishPO')->first();
                    ...
                    $promedios['admin_data'][$user->id]['mathNoveno'] = MathNoveno::where('user_id', $user->id)->where('state', 'activo')->pluck('averagePNO')->first();
                    $promedios['admin_data'][$user->id]['spanishNoveno'] = SpanishNoveno::where('user_id', $user->id)->where('state', 'activo')->pluck('averageSpanishPNO')->first();
                    ...
                    $promedios['admin_data'][$user->id]['mathDecimo'] = MathDecimo::where('user_id', $user->id)
                    ->where('state', 'activo')->pluck('averagePD')->first();
                    $promedios['admin_data'][$user->id]['spanishDecimo'] = SpanishDecimo::where('user_id', $user->id)
                    ->where('state', 'activo')->pluck('averageSpanishPD')->first();
